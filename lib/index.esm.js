...
var FormImage = function (props) {
    ...
    return (jsxs(SharedElement, __assign$1({}, props, { children: [jsx("input", { ref: ref, id: props.id, type: "file", style: { display: 'none' }, accept: ".jpg,.jpeg,.png", onChange: onImageChosenHandler }, void 0),
            jsxs("div", __assign$1({ style: { display: 'flex', justifyContent: 'center', flexDirection: 'column' } }, { children: [jsx("div", __assign$1({ style: {
                            display: 'flex',
                            ...
                            height: 'auto',
                            marginBottom: '1rem'
                        } }, { children: props.value ? (jsx("img", { style: {
                                width: '100%',
                                height: 'auto',
                                objectFit: 'cover'
                            }, src: preview, alt: "Preview" }, void 0)) : (jsx("p", __assign$1({ style: __assign$1({}, getVariantChild(negateVariant(variant), 'tc')) }, { children: props.imagePreviewText || 'Please choose an image.' }), void 0)) }), void 0),
...
var FormSelect = function (props) {
    var _a;
    return (jsx(SharedElement, __assign$1({}, props, { children: jsx("div", __assign$1({ style: selectDiv }, { children: jsx("select", __assign$1({ id: props.id, style: __assign$1(__assign$1({}, selectStyles), getVariantCSS(props.variant || 'light')), disabled: !!props.disableSelect, multiple: !!props.multipleSelect, value: typeof props.value === 'boolean' ||
