...
import _react, { useState, useCallback, useEffect, createElement } from 'react';
...
var FormInput = function (props) {
    ...
    return (jsxs("div", __assign({ style: __assign(__assign({}, defaultInputWrapperStyle), { width: props.width }) }, { children: [props.label && (jsx("label", __assign({ style: __assign(__assign({}, defaultLabelStyle), getVariantChild(negatedVariant, 'tc')) }, { children: props.label }), void 0)),
            jsx("input", { type: props.type || 'text', id: props.id, onChange: props.onChange, onBlur: props.onBlur, value: (_a = props.value) === null || _a === void 0 ? void 0 : _a.toString(), placeholder: props.placeholder, style: __assign(__assign({}, __assign(__assign({}, defaultInputStyle), getVariantCSS(variant))), (props.isValid
                    ? defaultValidStyle
                    : props.isInvalid
                        ? defaultInvalidStyle
                        : {})) }, void 0),
            props.validFeedback && props.isValid ? (jsx("div", __assign({ style: defaultValidFeedbackStyle }, { children: props.validFeedback }), void 0)) : props.invalidFeedback && props.isInvalid ? (jsx("div", __assign({ style: defaultInvalidFeedbackStyle }, { children: props.invalidFeedback }), void 0)) : null,
            props.helperText && (jsx("small", __assign({ style: __assign(__assign({}, defaultHelperTextStyle), getVariantChild(negatedVariant, 'tc')) }, { children: props.helperText }), void 0))] }), void 0));
};
...
function Form(props) {
    ...
    return (jsxs("form", __assign({ onSubmit: onSubmit }, { children: [jsx("h1", { children: "Header Text" }, void 0),
            jsx("hr", {}, void 0),
            jsx("div", { children: Object.keys(formState.inputs).map(function (id, index) {
            ...
            jsxs("div", { children: [jsx(FormButton, { disabled: !formState.isValid, type: "submit" }, void 0),
                    props.onCancel && (jsx(FormButton, { type: "button", variant: "light", buttonText: props.cancelText || 'CANCEL', onClick: props.onCancel }, void 0))] }, void 0)] }), void 0));
}
