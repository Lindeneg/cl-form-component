...
var SharedElement = function (props) {
    ...
    return (jsxRuntime.jsxs("div", __assign$1({ style: __assign$1(__assign$1(__assign$1({}, styles.defaultInputWrapperStyle), (props.center ? { justifyContent: 'center', textAlign: 'center' } : {})), { width: props.width }) }, { children: [props.label && (jsxRuntime.jsx("label", __assign$1({ style: __assign$1(__assign$1({}, styles.defaultLabelStyle), getVariantChild(negatedVariant, 'tc')) }, { children: props.label }), void 0)), props.children, !props.noValidation && props.validFeedback && props.isValid ? (jsxRuntime.jsx("div", __assign$1({ style: styles.defaultValidFeedbackStyle }, { children: props.validFeedback }), void 0)) : !props.noValidation && props.invalidFeedback && props.isInvalid ? (jsxRuntime.jsx("div", __assign$1({ style: styles.defaultInvalidFeedbackStyle }, { children: props.invalidFeedback }), void 0)) : null,
            props.helperText && (jsxRuntime.jsx("small", __assign$1({ style: __assign$1(__assign$1({}, styles.defaultHelperTextStyle), getVariantChild(negatedVariant, 'tc')) }, { children: props.helperText }), void 0))] }), void 0));
};

var FormInput = function (props) {
    var _a;
    return (jsxRuntime.jsx(SharedElement, __assign$1({}, props, { children: jsxRuntime.jsx("input", { type: props.type || 'text', id: props.id, onChange: props.onChange, onBlur: props.onBlur, value: (_a = props.value) === null || _a === void 0 ? void 0 : _a.toString(), placeholder: props.placeholder, style: __assign$1(__assign$1({}, __assign$1(__assign$1({}, styles.defaultInputStyle), getVariantCSS(props.variant || 'light'))), (props.noValidation === true
                ? {}
...
var FormTextField = function (props) {
    var _a;
    return (jsxRuntime.jsx(SharedElement, __assign$1({}, props, { children: jsxRuntime.jsx("textarea", { id: props.id, onChange: props.onChange, onBlur: props.onBlur, value: (_a = props.value) === null || _a === void 0 ? void 0 : _a.toString(), placeholder: props.placeholder, rows: props.rows || 3, cols: props.cols || 1, style: __assign$1(__assign$1({}, __assign$1(__assign$1({}, styles.defaultTextAreaStyle), getVariantCSS(props.variant || 'light'))), (props.noValidation === true
                ? {}
                : props.isValid && !props.isInvalid
                    ? styles.defaultValidStyle
                    : props.isInvalid
...
var FormButton = function (props) {
    ...
    var getColor = react.useCallback(function (hover) { return getVariantCSS(variant, hover); }, [
        variant
    ]);
...
var FormImage = function (props) {
    ...
    return (jsxRuntime.jsxs(SharedElement, __assign$1({}, props, { children: [jsxRuntime.jsx("input", { ref: ref, id: props.id, type: "file", style: { display: 'none' }, accept: ".jpg,.jpeg,.png", onChange: onImageChosenHandler }, void 0),
            jsxRuntime.jsxs("div", __assign$1({ style: { display: 'flex', justifyContent: 'center', flexDirection: 'column' } }, { children: [jsxRuntime.jsxs("div", __assign$1({ style: {
                            display: 'flex',
                            ...
                            height: 'auto',
                            marginBottom: '1rem'
                        } }, { children: [preview && (jsxRuntime.jsx("img", { style: {
                                    width: '100%',
                                    height: 'auto',
                                    objectFit: 'cover'
                                }, src: preview, alt: "Preview" }, void 0)),
                            !preview && (jsxRuntime.jsx("p", __assign$1({ style: __assign$1({}, getVariantChild(negateVariant(variant), 'tc')) }, { children: props.ImagepreviewText || 'Please choose an image.' }), void 0))] }), void 0),
                    jsxRuntime.jsx(FormButton, { variant: negateVariant(variant), buttonText: props.ImagebuttonText ? props.ImagebuttonText : 'UPLOAD', type: "button", onClick: onImageUploadHandler }, void 0)] }), void 0)] }), void 0));
};
...
var FormSelect = function (props) {
    var _a;
    return (jsxRuntime.jsx(SharedElement, __assign$1({}, props, { children: jsxRuntime.jsx("div", __assign$1({ style: selectDiv }, { children: jsxRuntime.jsx("select", __assign$1({ id: props.id, style: __assign$1(__assign$1({}, selectStyles), getVariantCSS(props.variant || 'light')), disabled: !!props.disableSelect, multiple: !!props.multipleSelect, value: typeof props.value === 'boolean' || props.value instanceof File
                    ? ''
                    ...
                    return (jsxRuntime.jsx("option", __assign$1({ value: value }, { children: displayValue || capitalize(value) }), index));
...
function onImageInvalidUpload(formState, id, noValidation) {
    ...
    if (formState.inputs[id].isValid) {
        return __assign$1(__assign$1({}, formState), { inputs: __assign$1(__assign$1({}, formState.inputs), (_a = {}, _a[id] = __assign$1(__assign$1({}, formState.inputs[id]), { value: '', isValid: noValidation, isTouched: true }), _a)), isValid: formState.isValid && noValidation });
    }
    return formState;
}
...
function Form(props) {
    ...
    return (jsxRuntime.jsxs("div", __assign$1({ id: props.wrapperId, style: __assign$1({ width: props.width || '100%', paddingRight: '15px', paddingLeft: '15px', marginRight: 'auto', marginLeft: 'auto', boxSizing: 'border-box' }, getVariantCSS(variant)) }, { children: [props.headerText && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("h4", __assign$1({ style: {
                            paddingTop: '1rem',
                            fontSize: '1.5rem',
                            marginBottom: '.5rem',
                            fontWeight: 'normal',
                    ...
                    jsxRuntime.jsx("hr", { style: { marginBottom: '1rem' } }, void 0)] }, void 0)),
            jsxRuntime.jsxs("form", __assign$1({ style: { paddingBottom: '1rem', boxSizing: 'border-box' }, onSubmit: onSubmit }, { children: [Object.keys(formState.inputs).map(function (id, index) {
                        ...
                        switch (target.elementType) {
                            case 'text-field':
                                return react.createElement(FormTextField, __assign$1({}, baseProps, { key: index }));
                            case 'selection':
                                return (react.createElement(FormSelect, __assign$1({}, baseProps, { key: index, onChange: onSelect, onClick: onMultipleSelect.bind(null, baseProps.noValidation === true) })));
                            case 'image':
                                return (react.createElement(FormImage, __assign$1({}, baseProps, { key: index, onImageUpload: onValidUpload, onInvalidImageUpload: onInvalidUpload })));
                            case 'input':
                            default:
                                return react.createElement(FormInput, __assign$1({}, baseProps, { key: index }));
                        }
                    }),
                    jsxRuntime.jsxs("div", __assign$1({ style: {
                            display: 'flex',
                            boxSizing: 'border-box',
                            justifyContent: 'space-between'
                        } }, { children: [jsxRuntime.jsx(FormButton, { buttonText: props.submissionText || 'SUBMIT', variant: negateVariant(variant), disabled: !formState.isValid, type: "submit" }, void 0),
                            props.onCancel && (jsxRuntime.jsx(FormButton, { type: "button", variant: variant, buttonText: props.cancelText || 'CANCEL', onClick: props.onCancel }, void 0))] }), void 0)] }), void 0)] }), void 0));
}
