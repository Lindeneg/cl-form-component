...
var FormInput = function (props) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ style: __assign(__assign({}, defaultInputWrapperStyle), { width: props.width }) }, { children: [props.label && (jsxRuntime.jsx("label", __assign({ style: __assign(__assign({}, defaultLabelStyle), getVariantChild(negatedVariant, 'tc')) }, { children: props.label }), void 0)),
            jsxRuntime.jsx("input", { type: props.type || 'text', id: props.id, onChange: props.onChange, onBlur: props.onBlur, value: (_a = props.value) === null || _a === void 0 ? void 0 : _a.toString(), placeholder: props.placeholder, style: __assign(__assign({}, __assign(__assign({}, defaultInputStyle), getVariantCSS(variant))), (props.isValid
                    ? defaultValidStyle
                    : props.isInvalid
                        ? defaultInvalidStyle
                        : {})) }, void 0),
            props.validFeedback && props.isValid ? (jsxRuntime.jsx("div", __assign({ style: defaultValidFeedbackStyle }, { children: props.validFeedback }), void 0)) : props.invalidFeedback && props.isInvalid ? (jsxRuntime.jsx("div", __assign({ style: defaultInvalidFeedbackStyle }, { children: props.invalidFeedback }), void 0)) : null,
            props.helperText && (jsxRuntime.jsx("small", __assign({ style: __assign(__assign({}, defaultHelperTextStyle), getVariantChild(negatedVariant, 'tc')) }, { children: props.helperText }), void 0))] }), void 0));
};
...
function getInputs(entries) {
    var inputs = {};
    Object.keys(entries).forEach(function (key) {
        var entry = entries[key];
        inputs[key] = lib.getInput(entry.value || '', entry.options);
    });
    return inputs;
}
...
function Form(props) {
    var _a = useForm(getInputs(props.entries)), formState = _a.formState, onChangeHandler = _a.onChangeHandler, onTouchHandler = _a.onTouchHandler;
    var onSubmit = function (e) {
        e.preventDefault();
        props.onSubmit(getResult(formState.inputs));
    };
    return (jsxRuntime.jsxs("form", __assign({ onSubmit: onSubmit }, { children: [jsxRuntime.jsx("h1", { children: "Header Text" }, void 0),
            jsxRuntime.jsx("hr", {}, void 0),
            jsxRuntime.jsx("div", { children: Object.keys(formState.inputs).map(function (id, index) {
            ...
            jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(FormButton, { disabled: !formState.isValid, type: "submit" }, void 0),
                    props.onCancel && (jsxRuntime.jsx(FormButton, { type: "button", variant: "light", buttonText: props.cancelText || 'CANCEL', onClick: props.onCancel }, void 0))] }, void 0)] }), void 0));
}
