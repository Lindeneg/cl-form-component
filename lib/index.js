...
function useForm(initialState) {
  var _useReducer = (0, _react__default['default'].useReducer)(formReducer, _objectSpread({}, getState(initialState))),
      _useReducer2 = (0, _slicedToArray2["default"])(_useReducer, 2),
      formState = _useReducer2[0],
      dispatch = _useReducer2[1];

  var setFormState = (0, _react__default['default'].useCallback)(function (state) {
    dispatch({
  ...
  var onTouchHandler = (0, _react__default['default'].useCallback)(function (event) {
    dispatch({
  ...
  var onChangeHandler = (0, _react__default['default'].useCallback)(function (event) {
    dispatch({
...
var FormTextField = function (props) {
    var _a;
    return (jsxRuntime.jsx(SharedElement, __assign({}, props, { children: jsxRuntime.jsx("textarea", { id: props.id, onChange: props.onChange, onBlur: props.onBlur, value: (_a = props.value) === null || _a === void 0 ? void 0 : _a.toString(), placeholder: props.placeholder, rows: props.rows || 3, cols: props.cols || 1, style: __assign(__assign({}, __assign(__assign({}, styles.defaultTextAreaStyle), getVariantCSS(props.variant || 'light'))), (props.noValidation === true
                ? {}
                : props.isValid && !props.isInvalid
                    ? styles.defaultValidStyle
                    : props.isInvalid
...
var FormButton = function (props) {
    var _a = _react.useState(), styles = _a[0], setStyles = _a[1];
    var disableDefaultStyles = props.disableDefaultStyles, baseStyles = props.baseStyles, variant = props.variant;
    var getColor = _react.useCallback(function (hover) { return getVariantCSS(variant, hover); }, [
        variant
    ]);
...
var FormImage = function (props) {
    ...
    return (jsxRuntime.jsxs(SharedElement, __assign({}, props, { children: [jsxRuntime.jsx("input", { ref: ref, id: props.id, type: "file", style: { display: 'none' }, accept: ".jpg,.jpeg,.png", onChange: onImageChosenHandler }, void 0),
            jsxRuntime.jsxs("div", __assign({ style: { display: 'flex', justifyContent: 'center', flexDirection: 'column' } }, { children: [jsxRuntime.jsxs("div", __assign({ style: {
                            display: 'flex',
                            ...
                            !preview && (jsxRuntime.jsx("p", __assign({ style: __assign({}, getVariantChild(negateVariant(variant), 'tc')) }, { children: props.ImagepreviewText || 'Please choose an image.' }), void 0))] }), void 0),
...
function Form(props) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ style: __assign({ width: props.width || '100%', paddingRight: '15px', paddingLeft: '15px', marginRight: 'auto', marginLeft: 'auto', boxSizing: 'border-box' }, getVariantCSS(variant)) }, { children: [props.headerText && (jsxRuntime.jsx("h4", __assign({ style: {
                    paddingTop: '1rem',
                    fontSize: '1.5rem',
                    marginBottom: '.5rem',
                    fontWeight: 'normal',
            ...
            jsxRuntime.jsx("hr", { style: { marginBottom: '1rem' } }, void 0),
            jsxRuntime.jsxs("form", __assign({ style: { paddingBottom: '1rem', boxSizing: 'border-box' }, onSubmit: onSubmit }, { children: [Object.keys(formState.inputs).map(function (id, index) {
                        ...
                        switch (target.elementType) {
                            case 'text-field':
                                return (_react.createElement(FormTextField, __assign({}, baseProps, { rows: target.rows, key: index, placeholder: target.placeholder })));
                            case 'selection':
                                return null;
                            case 'image':
                                return (_react.createElement(FormImage, __assign({}, baseProps, { key: index, onImageUpload: onImageUpload, onInvalidImageUpload: onImageInvalid })));
                            case 'input':
                            default:
                                return (_react.createElement(FormInput, __assign({}, baseProps, { key: index, placeholder: target.placeholder })));
                        }
                    }),
