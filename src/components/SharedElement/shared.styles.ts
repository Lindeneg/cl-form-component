...
const defaultInputWrapperStyle: CSSProperties = {
    position: 'relative',
    display: 'flex',
    flexWrap: 'wrap',
...
const defaultHelperTextStyle: CSSProperties = {
    display: 'block',
    width: '100%',
    marginTop: '.25rem',
    fontSize: '80%',
...
const defaultValidStyle: CSSProperties = {
...
const defaultInvalidStyle: CSSProperties = {
    ...defaultValidStyle,
...
const defaultValidFeedbackStyle: CSSProperties = {
    display: 'block',
    color: '#28a745',
    width: '100%',
    boxSizing: 'border-box',
...
const defaultInvalidFeedbackStyle: CSSProperties = {
